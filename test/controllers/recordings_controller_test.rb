...
class RecordingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create recording" do
    assert_difference('Recording.count') do
      post recordings_url, params: { recording: { location: @recording.location, status: @recording.status, tempt: @recording.tempt } }
    end
  ...
  test "should update recording" do
    patch recording_url(@recording), params: { recording: { location: @recording.location, status: @recording.status, tempt: @recording.tempt } }
